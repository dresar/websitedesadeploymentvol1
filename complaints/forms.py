...
class AdminNotesForm(forms.Form):
    """Form for admin notes with Summernote"""
    ...
    class Meta:
        ...
        widgets = {
            'reporter_name': forms.TextInput(attrs={
                'class': 'w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200',
            ...
            'reporter_address': forms.Textarea(attrs={
                'class': 'w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 resize-y',
                'rows': 3,
                'placeholder': 'Alamat lengkap Anda'
            }),
            'category': forms.Select(attrs={
                'class': 'w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 appearance-none',
                'required': True
            }),
            ...
            'attachment': forms.FileInput(attrs={
                'class': 'w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100',
...
class ComplaintVerificationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'verification_notes': SummernoteWidget(attrs={
                'summernote': {'height': 200, 'lang': 'id-ID'},
                'class': 'form-control'
            }),
            'verification_result': SummernoteWidget(attrs={
                'summernote': {'height': 200, 'lang': 'id-ID'},
                'class': 'form-control'
            }),
            'supporting_evidence': SummernoteWidget(attrs={
                'summernote': {'height': 200, 'lang': 'id-ID'},
                'class': 'form-control'
            }),
            'recommended_action': SummernoteWidget(attrs={
                'summernote': {'height': 200, 'lang': 'id-ID'},
                'class': 'form-control'
            }),
            ...
            'follow_up_notes': SummernoteWidget(attrs={
                'summernote': {'height': 200, 'lang': 'id-ID'},
                'class': 'form-control'
            })
        }
...
class ComplaintAdminNotesForm(forms.ModelForm):
    """Formulir untuk catatan admin pengaduan"""
    ...
    class Meta:
        ...
        widgets = {
            'admin_notes': SummernoteWidget(attrs={
                'summernote': {'height': 200, 'lang': 'id-ID'},
                'class': 'form-control'
            })
        }
