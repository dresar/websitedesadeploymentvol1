...
urlpatterns = [
    ...
    path('sukses/<str:complaint_id>/', views.complaint_success_view, name='complaint_success'),
    ...
    path('detail/<str:complaint_id>/', views.complaint_detail_view, name='complaint_detail'),
