...
def generate_complaint_id():
    """Generate random 4-character complaint ID (uppercase, lowercase, and digits)"""
    characters = string.ascii_uppercase + string.ascii_lowercase + string.digits
    while True:
        complaint_id = ''.join(random.choices(characters, k=4))
...
class Complaint(models.Model):
    ...
    # Identifikasi
    complaint_id = models.CharField(max_length=4, default=generate_complaint_id, editable=False, unique=True, verbose_name='ID Pengaduan')
