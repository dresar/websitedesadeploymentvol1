...
def organization_hierarchy(request):
    ...
    stats = {
        ...
        'sekretaris_desa': VillageOfficial.objects.filter(position='SEKRETARIS', is_active=True).count(),
        ...
        'kepala_dusun': VillageOfficial.objects.filter(position='KADUS', is_active=True).count(),
    }
...
def pkk_list(request):
    ...
    if search_query:
        pkk = pkk.filter(
            Q(penduduk__nama__icontains=search_query) |
    ...
    context = {
        ...
        'penggerak_pkk': page_obj,  # Pass paginated object
...
def ajax_perangkat_desa_filter(request):
    ...
    # Render the results
    html = render_to_string('public/organization/perangkat_desa_list.html', {
...
def ajax_lembaga_adat_filter(request):
    ...
    # Render the results
    html = render_to_string('public/organization/lembaga_adat_list.html', {
...
def ajax_pkk_filter(request):
    ...
    # Render the results
    html = render_to_string('public/organization/pkk_list.html', {
...
def ajax_kepemudaan_filter(request):
    ...
    # Render the results
    html = render_to_string('public/organization/kepemudaan_list.html', {
...
def ajax_karang_taruna_filter(request):
    ...
    # Render the results
    html = render_to_string('public/organization/karang_taruna_list.html', {
