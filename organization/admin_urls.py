...
urlpatterns = [
    ...
    # Admin API URLs (legacy - for dashboard stats)
    ...
    # path('api/karang-taruna/', api.admin_api_karang_taruna, name='api_karang_taruna'),  # Replaced by paginated version below
    ...
    # Admin API List URLs (with pagination)
    path('api/pkk/', views.api_admin_pkk_list, name='api_admin_pkk_list'),
    path('api/karang-taruna/', views.api_admin_karang_taruna_list, name='api_admin_karang_taruna_list'),
