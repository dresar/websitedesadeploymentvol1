...
urlpatterns = [
    ...
    path('official/<int:official_id>/', views.official_detail_view, name='official_detail'),
    ...
    path('admin/geography/', admin_views.village_profile_geography, name='admin_geography'),
    path('admin/demography/', admin_views.village_profile_demography, name='admin_demography'),
    ...
    path('admin/facility/form/', admin_views.facility_form_view, name='admin_facility_form'),
    path('admin/facility/form/<int:facility_id>/', admin_views.facility_form_view, name='admin_facility_form_edit'),
    path('admin/history/', admin_views.village_profile_history, name='admin_history'),
    path('admin/history/form/', admin_views.history_form_view, name='admin_history_form'),
    path('admin/history/form/<int:history_id>/', admin_views.history_form_view, name='admin_history_form_edit'),
    ...
    path('admin/gallery/form/', admin_views.gallery_form_view, name='admin_gallery_form'),
    path('admin/gallery/form/<int:photo_id>/', admin_views.gallery_form_view, name='admin_gallery_form_edit'),
