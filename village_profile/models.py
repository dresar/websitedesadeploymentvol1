...
class VillageProfile(models.Model):
    ...
    description = models.TextField(blank=True, null=True, verbose_name="Deskripsi Desa")
    ...
    # Vision and Mission
    vision = models.TextField(blank=True, null=True, verbose_name="Visi")
    mission = models.TextField(blank=True, null=True, verbose_name="Misi", help_text="Pisahkan setiap misi dengan baris baru")
...
class VillageGeography(models.Model):
    ...
    # Coordinates
    latitude = models.DecimalField(max_digits=10, decimal_places=7, blank=True, null=True, verbose_name="Lintang")
    longitude = models.DecimalField(max_digits=10, decimal_places=7, blank=True, null=True, verbose_name="Bujur")
    altitude = models.IntegerField(blank=True, null=True, verbose_name="Ketinggian (mdpl)")
    
    # Climate
    climate = models.CharField(max_length=100, blank=True, null=True, verbose_name="Iklim")
    rainfall = models.IntegerField(blank=True, null=True, verbose_name="Curah Hujan (mm/tahun)")
    temperature_min = models.IntegerField(blank=True, null=True, verbose_name="Suhu Minimum (°C)")
    temperature_max = models.IntegerField(blank=True, null=True, verbose_name="Suhu Maksimum (°C)")
    
    # Topography
    topography = models.CharField(max_length=100, blank=True, null=True, verbose_name="Topografi")
    soil_type = models.CharField(max_length=100, blank=True, null=True, verbose_name="Jenis Tanah")
    
    # Boundaries
    boundary_north = models.CharField(max_length=100, blank=True, null=True, verbose_name="Batas Utara")
    boundary_south = models.CharField(max_length=100, blank=True, null=True, verbose_name="Batas Selatan")
    boundary_east = models.CharField(max_length=100, blank=True, null=True, verbose_name="Batas Timur")
    boundary_west = models.CharField(max_length=100, blank=True, null=True, verbose_name="Batas Barat")
...
class VillageOfficial(models.Model):
    ...
    penduduk = models.ForeignKey('references.Penduduk', on_delete=models.SET_NULL, blank=True, null=True,
                                 related_name='official_positions', verbose_name="Data Penduduk")
