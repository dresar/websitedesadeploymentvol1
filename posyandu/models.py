...
class PosyanduLocation(models.Model):
    ...
    coordinator = models.ForeignKey('references.Penduduk', on_delete=models.SET_NULL, null=True, blank=True, related_name='coordinated_posyandu')
...
class HealthRecord(models.Model):
    ...
    patient = models.ForeignKey('references.Penduduk', on_delete=models.CASCADE, related_name='health_records')
...
class Immunization(models.Model):
    ...
    patient = models.ForeignKey('references.Penduduk', on_delete=models.CASCADE, related_name='immunizations')
    posyandu = models.ForeignKey(PosyanduLocation, on_delete=models.CASCADE)
...
class NutritionData(models.Model):
    ...
    patient = models.ForeignKey('references.Penduduk', on_delete=models.CASCADE, related_name='nutrition_data')
    posyandu = models.ForeignKey(PosyanduLocation, on_delete=models.CASCADE)
...
class PosyanduKader(models.Model):
    ...
    penduduk = models.ForeignKey('references.Penduduk', on_delete=models.CASCADE, related_name='kader_posyandu')
...
class IbuHamil(models.Model):
    ...
    penduduk = models.ForeignKey('references.Penduduk', on_delete=models.CASCADE, related_name='kehamilan')
    posyandu = models.ForeignKey(PosyanduLocation, on_delete=models.CASCADE)
...
class StuntingData(models.Model):
    ...
    balita = models.ForeignKey('references.Penduduk', on_delete=models.CASCADE, related_name='stunting_data')
    posyandu = models.ForeignKey(PosyanduLocation, on_delete=models.CASCADE)
