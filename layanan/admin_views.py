...
def feedback_form(request):
    ...
    # Check id from both GET and POST
...
def faq_form(request):
    """Create or edit FAQ"""
    # Check id from both GET and POST
    faq_id = request.GET.get('id') or request.POST.get('id')
    faq = None
...
def contact_form(request):
    ...
    # Check id from both GET and POST
    contact_id = request.GET.get('id') or request.POST.get('id')
    contact = None
...
def service_form(request):
    ...
    # Check id from both GET and POST
    service_id = request.GET.get('id') or request.POST.get('id')
    service = None
