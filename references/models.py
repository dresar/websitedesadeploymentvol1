...
class Lorong(models.Model):
    ...
    kode = models.CharField(max_length=15, blank=True, null=True)
    ketua_lorong = models.CharField(max_length=100, blank=True, null=True)
...
class Penduduk(models.Model):
    ...
    # Address Information
    dusun = models.ForeignKey(Dusun, on_delete=models.CASCADE, related_name='residents', blank=True, null=True, verbose_name="Dusun")
