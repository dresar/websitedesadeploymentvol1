...
urlpatterns = [
    ...
    path('export/<str:model_name>/<str:format>/', views_import_export.export_data, name='export_data'),
    ...
    path('global-import/', views_import_export.global_import, name='global_import'),
