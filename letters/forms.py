...
class LetterStatusForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'rejection_reason': SummernoteWidget(),
            'notes': SummernoteWidget(),
        }
...
class LetterTemplateForm(forms.ModelForm):
    """Form untuk template surat dengan Summernote"""
    
    class Meta:
        model = LetterTemplate
        fields = ['name', 'template_type', 'content_template', 'description']
        widgets = {
            'name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Nama template'}),
            'template_type': forms.Select(attrs={'class': 'form-control'}),
            'content_template': SummernoteWidget(),
            'description': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Deskripsi template'}),
        }