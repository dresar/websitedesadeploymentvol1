...
urlpatterns = [
    ...
    # path('complaints/', views.complaints_view, name='complaints'),  # Removed - conflicts with complaints app
    path('bantuna/', views.bantuna_view, name='bantuna'),
    path('offline/', views.offline_view, name='offline'),
    
    # Admin Panel URLs - Moved to admin_panel app
    
    # Settings Dashboard - Halaman utama dengan card kategori
    path('admin-panel/settings/', views.settings_dashboard, name='settings'),
    
    # Settings URLs - Specific pages
    path('admin-panel/settings/website/', views.website_settings, name='website_settings'),
    
    # Backward compatibility redirects
    path('admin-panel/website-settings/', lambda request: redirect('core:website_settings', permanent=True)),
    ...
    path('admin-panel/settings/users/add/', views.add_user, name='add_user'),
    path('admin-panel/settings/users/<int:user_id>/edit/', views.edit_user, name='edit_user'),
    path('admin-panel/settings/users/<int:user_id>/toggle/', views.toggle_user_status, name='toggle_user_status'),
    path('admin-panel/settings/users/<int:user_id>/delete/', views.delete_user, name='delete_user'),
    path('admin-panel/settings/logs/', views.activity_logs_view, name='activity_logs'),
    ...
    path('admin-panel/cache/clear/', views.clear_cache, name='clear_cache'),
    path('admin-panel/cache/clear-static/', views.clear_static_files, name='clear_static_files'),
    path('admin-panel/cache/clear-media/', views.clear_media_cache, name='clear_media_cache'),
    
    # Database Reset Management URLs
    path('admin-panel/database-reset/', admin_views.database_reset_list, name='database_reset_list'),
    path('admin-panel/database-reset/create/', admin_views.database_reset_create, name='database_reset_create'),
    path('admin-panel/database-reset/<int:config_id>/', admin_views.database_reset_detail, name='database_reset_detail'),
    path('admin-panel/database-reset/<int:config_id>/edit/', admin_views.database_reset_edit, name='database_reset_edit'),
    path('admin-panel/database-reset/<int:config_id>/execute/', admin_views.database_reset_execute, name='database_reset_execute'),
    path('admin-panel/database-reset/ajax/', admin_views.database_reset_ajax, name='database_reset_ajax'),
    
    # Database Backup Management URLs
    path('admin-panel/database-backup/', admin_views.database_backup_list, name='database_backup_list'),
    path('admin-panel/database-backup/create/', admin_views.database_backup_create, name='database_backup_create'),
    path('admin-panel/database-backup/<str:backup_name>/download/', admin_views.database_backup_download, name='database_backup_download'),
    path('admin-panel/database-backup/<str:backup_name>/restore/', admin_views.database_backup_restore, name='database_backup_restore'),
    path('admin-panel/database-backup/<str:backup_name>/delete/', admin_views.database_backup_delete, name='database_backup_delete'),
