    ...
    try:
        ...
        try:
            ...
            page_mapping = {
                ...
                'gallery': 'gallery',
                'complaint_form': 'complaints',  # URL name untuk halaman utama complaints
                'create_complaint': 'complaints',  # URL name untuk buat pengaduan
                'complaint_tracking': 'complaints',  # URL name untuk lacak pengaduan
                'complaint_list': 'complaints',  # URL name untuk daftar pengaduan
                'complaint_detail': 'complaints',  # URL name untuk detail pengaduan
                'layanan': 'layanan',
                'posyandu': 'posyandu',
                'public_posyandu_home': 'posyandu',
                'public_posyandu_services': 'posyandu',
                'public_posyandu_schedule': 'posyandu',
                'public_health_info': 'posyandu',
                'public_stunting_info': 'posyandu',
                'bantuna': 'bantuna',
            }
        ...
        return {
            ...
            'site_description': getattr(settings, 'site_description', settings.site_description),
            ...
            'enable_facebook_tracking': getattr(settings, 'enable_facebook_tracking', False),
            'site_title': getattr(settings, 'site_title', settings.site_name),
            'site_author': getattr(settings, 'site_author', 'Tim Website Pulosarok'),
            'site_language': getattr(settings, 'site_language', 'id'),
            'og_title': getattr(settings, 'og_title', ''),
            'og_description': getattr(settings, 'og_description', ''),
            'og_image': getattr(settings, 'og_image', None),
            'enable_maintenance_mode': getattr(settings, 'enable_maintenance_mode', False),
        ...
        return {
            ...
            'site_description': 'Website resmi Desa Pulosarok',
            'site_keywords': 'desa, pulosarok, website desa',
            'logo': None,
            'favicon': None,
            'hero_image': None,
            'hero_image_url': None,
            ...
            'maintenance_message': 'Website sedang dalam perbaikan. Terima kasih atas pengertian Anda.',
            'enable_cache': True,
            'cache_duration': 300,
        }
