...
urlpatterns = [
    ...
    path('admin/reports/export-excel/', views.admin_export_beneficiaries_excel, name='admin_export_beneficiaries_excel'),
    path('admin/reports/export-pdf/', views.admin_export_beneficiaries_pdf, name='admin_export_beneficiaries_pdf'),
