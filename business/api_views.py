...
# Import Penduduk directly from references app
    ...
    try:
        ...
        if Penduduk:
            ...
            for penduduk in penduduk_list:
                results.append({
                    'id': penduduk.id,
                    'nama': penduduk.name,  # Changed from 'name' to 'nama'
                    'nik': penduduk.nik,
                    'alamat': getattr(penduduk, 'address', '') or f"{penduduk.dusun.name if penduduk.dusun else ''}",  # Changed from 'address' to 'alamat'
                    ...
                    'provinsi': 'Jawa Timur',
                    'kode_pos': '68288',
                    'telepon': penduduk.phone_number or penduduk.mobile_number or '',  # Changed from 'phone_number' to 'telepon'
    ...
    try:
        ...
        if Penduduk:
            ...
            for penduduk in penduduk_list:
                results.append({
                    'id': penduduk.id,
                    'name': penduduk.name or 'Nama tidak tersedia',
                    'nik': penduduk.nik,
                    'address': penduduk.address or 'Alamat tidak tersedia',
                })
