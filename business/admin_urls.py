...
urlpatterns = [
    ...
    path('registrations/', admin_views.business_registration_list, name='business_registration_list'),
    path('registrations/<int:registration_id>/', admin_views.business_registration_detail, name='business_registration_detail'),
    path('registrations/<int:registration_id>/approve/', admin_views.business_registration_approve, name='business_registration_approve'),
    path('registrations/<int:registration_id>/reject/', admin_views.business_registration_reject, name='business_registration_reject'),
    path('registrations/<int:registration_id>/review/', admin_views.business_registration_under_review, name='business_registration_under_review'),
]
