...
urlpatterns = [
    ...
    path('', views.business_list_public, name='business_list'),
    # Removed business_detail URL - using specific URLs for each business type
    path('daftar/', views.business_register, name='business_register'),
    path('daftar/sukses/<int:registration_id>/', views.business_register_success, name='business_register_success'),
